...
class MockService implements ISpreadsheetService {
  ...
  async authenticate(): Promise<any> { return {}; }
  async isAuthenticated(): Promise<boolean> { return true; }
  async refreshAuth(): Promise<any> { return {}; }
  async store(): Promise<any> { return { success: true }; }
  async deleteRows(): Promise<any> { return { success: true }; }
  async updateRows(): Promise<any> { return { success: true }; }
  async clearAuth(): Promise<void> {}
  async migrate(): Promise<any> { return { success: true }; }
  
  async retrieve<T = any>(): Promise<any> {
    return {
      success: true,
      data: [
